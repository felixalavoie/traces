...
class Session
{
    ...
    // Gestion de la sessions
    public function demarrer():void
    {
        session_start(['cookie_lifetime' => 0]);
        // À zéro, la sessions va terminer après la fermeture du navigateur (sécurité).
    }

    public function supprimer():void
    {
        session_unset();  // Supprimer les variables dans le tableau $_SESSION
        session_destroy();  // Détruire les fichiers associés à l'identifiant de sessions sur le serveur.
        setcookie(session_name(),'',1);  // Demander au navigateur de supprimer le cookie contenant l’identifiant de sessions côté client.
    }
